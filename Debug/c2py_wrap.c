...
SWIGINTERN PyObject *_wrap_Step_Init(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  
  if (!SWIG_Python_UnpackTuple(args, "Step_Init", 0, 0, 0)) SWIG_fail;
  Step_Init();
  resultobj = SWIG_Py_Void();
  return resultobj;
fail:
...
SWIGINTERN PyObject *_wrap_Step_Detection(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  int16_t *arg1 ;
  int16_t const temp1[3] ;
  PyObject *swig_obj[1] ;
  uint8_t result;
  ...
  swig_obj[0] = args;
  {
    ...
    if (PyTuple_Check(swig_obj[0])) {
      if (!PyArg_ParseTuple(swig_obj[0], "hhh", temp1, temp1+1, temp1+2)) {
  ...
  result = (uint8_t)Step_Detection((short const (*))arg1);
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "Step_Init", _wrap_Step_Init, METH_NOARGS, NULL},
	 { "Step_Detection", _wrap_Step_Detection, METH_O, NULL},
	 { NULL, NULL, 0, NULL }
};
